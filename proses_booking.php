...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Note: Skipping availability check since old schema doesn't support date-based booking conflicts
    
    try {
        // Mulai transaksi
        $conn->begin_transaction();
        
        // Insert booking (using old schema)
        ...
        // Insert pembayaran (using correct column names)
        ...
        header("Location: user/transaksi.php?booking_id=" . $booking_id);
        exit;
